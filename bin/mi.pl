...
Readonly my %REQUIREMENT_CONTENTS =>
    (
        ...
        7 => ['(! [A,B] : ((m2_hidden(A) & m2_hidden(B)) => (r2_hidden(A,B) => m1_subset_1(A,B))))',
              '(! [A,B] : ((m2_hidden(A) & m2_hidden(B)) => ((m1_subset_1(A,B) & (~ v1_xboole_0(B))) => r2_hidden(A,B))))',
          '(! [A,B] : ((m2_hidden(A) & m2_hidden(B)) => (m1_subset_1(A,B) <=> r1_tarski(A,B))))',
          '(! [A,B,C] : ((m2_hidden(A) & m2_hidden(B) & m2_hidden(C)) => ((r2_hidden(A,B) & m1_subset_1(B,C)) => m1_subset_1(A,B))))',
          '(! [A,B,C] : ((m2_hidden(A) & m2_hidden(B) & m2_hidden(C)) => ((r2_hidden(A,B) & m1_subset_1(B,C)) => (~ v1_xboole_0(C)))))'],
